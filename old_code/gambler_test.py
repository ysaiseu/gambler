...
def init():
    ...
    arg1 = ['back', 'mid', 'first']
    arg2 = ['one', 'two', 'thr', 'd_one', 'd_two', 'd_thr', 'triple']

    #this code change win_first_one to win['first']['one']
    win = {}
    for i in range(arg1):
        win[arg1[i]] = {}
        for j in range(arg2):
            win[arg1[i]][arg2[j]] = win_list(i*10 + j + 1)
    ...
    monitor_list.append(win['back']['one'].monitor(6, 0.3, 12)
    ##监控部分
    monitor_list = []
